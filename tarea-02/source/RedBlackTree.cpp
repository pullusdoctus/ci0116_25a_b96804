...
void RBTree<DataType>::insert(const DataType &value) {
  ...
  // the new node
  // set both of z's children as sentinels
  // the new node starts red
...
template <typename DataType>
void RBTree<DataType>::transplant(
  RBTreeNode<DataType>* u, RBTreeNode<DataType>* v) {
